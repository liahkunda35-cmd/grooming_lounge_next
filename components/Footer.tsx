    ...
    <footer className="footer">
      <div className="container footer__inner">
        <div className="footer__brand">
          ...
          <p className="footer__tagline">Your look gives you confidence.</p>
          <p className="footer__location">Munaro Plaza &amp; Ibex Hub, Lusaka</p>
        </div>
        ...
        <div className="footer__social">
          ...
          <a
            href="https://www.instagram.com/groomingloungebarbershop"
            className="social-icon social-icon--instagram social-icon--sm"
            target="_blank"
            rel="noopener noreferrer"
      ...
      <div className="footer__bottom">
        <div className="container">
          <p>
            &copy; <span id="footer-year">2026</span> Grooming Lounge Barbershop &amp; Salon. All rights
            reserved.
          </p>
        </div>
      </div>
